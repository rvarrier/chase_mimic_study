...
let exportOptions = {
  ...
  exportPath: "/Users/f0053cz/Documents/GitHub/chase_mimic_study/test_version/vids/wander/wander_.webm",
  variationGroups: [],
  frameRate: 30,
  motionBlurFrames: 0,
  quality: 1,
  numRecollapses: 5, // change this to 5 in the final version
  doExportState: true,
  doExportPsyn: true,
  doExportCheat: false
};
